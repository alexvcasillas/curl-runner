...
- [Default Request Settings](#default-request-settings)
  - [Setting Precedence Order](#setting-precedence-order)
- [Production Configuration Example](#production-configuration-example)
- [Environment Integration](#environment-integration)
- [Global Configuration Best Practices](#global-configuration-best-practices)

## Overview

```yaml title="global-config-complete.yaml"
...
| --- | --- | --- | --- |
| execution | 'sequential' | 'parallel' | 'sequential' | How to execute multiple requests |
| continueOnError | boolean | false | Whether to continue execution after errors |
| variables | Record&lt;string, string&gt; | {} | Global variables for all requests |
| output | OutputConfig | - | Output formatting configuration |
| defaults | Partial&lt;RequestConfig&gt; | {} | Default settings for all requests |
...
> **Drawbacks:**
>
> Use for: Dependent requests, workflows, login sequences
>
> Benefits: Predictable order, can use previous responses
>
> Drawbacks: Slower total execution time

> **Drawbacks:**
>
> Use for: Load testing, independent health checks
>
> Benefits: Faster execution, higher throughput
>
> Drawbacks: No request dependencies, resource intensive
...
| --- | --- | --- |
| verbose | boolean | Show detailed execution information |
| showHeaders | boolean | Include response headers in output |
| showBody | boolean | Include response body content |
| showMetrics | boolean | Show performance timing metrics |
| format | 'json' | 'pretty' | 'raw' | Output format style |
...
```yaml title="defaults-config.yaml"
# Default Request Settings
