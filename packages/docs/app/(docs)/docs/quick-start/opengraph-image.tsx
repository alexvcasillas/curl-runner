...
export const alt = 'Quick Start | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Get started in minutes with YAML configuration
        </p>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>1️⃣</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Install</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>2️⃣</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Create YAML</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>3️⃣</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Run</span>
          </div>
        </div>
      </div>
