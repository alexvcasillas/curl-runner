...
export const alt = 'Snapshot Testing | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image() {
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Capture</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>🔍</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Compare</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>✅</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Validate</span>
          </div>
        </div>
      </div>
      ...
      >
        https://www.curl-runner.com/docs/features/snapshots
      </div>
    </div>,
    { ...size },
  );
