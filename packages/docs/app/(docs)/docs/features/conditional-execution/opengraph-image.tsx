...
export const alt = 'Conditional Execution | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
...
export default async function Image() {
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Workflow Branching</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>⚡</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Dynamic Conditions</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>🎯</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>Error Handling</span>
          </div>
        </div>
      </div>
      ...
      >
        https://www.curl-runner.com/docs/features/conditional-execution
      </div>
    </div>,
    { ...size },
  );
