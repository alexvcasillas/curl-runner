        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="rounded-lg border bg-muted/50 p-4">
              <p className="text-sm">
                <strong>Note:</strong> By default, curl-runner executes requests sequentially. Enable parallel execution using the <code className="text-xs bg-background px-1 py-0.5 rounded">{"execution: parallel"}</code> setting in your YAML file or the <code className="text-xs bg-background px-1 py-0.5 rounded">--parallel</code> CLI flag.
              </p>
            </div>
          </section>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b">
                    ...
                    <td className="p-3 text-sm text-muted-foreground">"parallel" or "sequential" (default: "sequential")</td>
                  </tr>
                  <tr className="border-b">
                    <td className="p-3"><code className="text-sm">continueOnError</code></td>
                    <td className="p-3 text-sm text-muted-foreground">boolean</td>
                    <td className="p-3 text-sm text-muted-foreground">Continue executing remaining requests if one fails</td>
                  </tr>
                  <tr>
                    <td className="p-3"><code className="text-sm">timeout</code></td>
                    <td className="p-3 text-sm text-muted-foreground">number</td>
                    <td className="p-3 text-sm text-muted-foreground">Global timeout for each request in milliseconds</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              When running requests in parallel, you can control how errors are handled using the <code className="text-sm bg-muted px-1 py-0.5 rounded">continueOnError</code> setting.
            </p>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">By default, if any request fails, curl-runner will cancel remaining requests</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium">Continue on Error <Badge className="ml-2 bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20">Recommended</Badge></p>
                    <p className="text-sm text-muted-foreground mt-1">Set <code className="text-xs bg-muted px-1 py-0.5 rounded">{"continueOnError: true"}</code> to complete all requests regardless of failures</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="border rounded-lg overflow-hidden">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b">
                      <td className="p-3"><code className="text-sm">--parallel</code></td>
                      <td className="p-3 text-sm text-muted-foreground">Force parallel execution</td>
                    </tr>
                    <tr className="border-b">
                      <td className="p-3"><code className="text-sm">--sequential</code></td>
                      <td className="p-3 text-sm text-muted-foreground">Force sequential execution</td>
                    </tr>
                    <tr>
                      <td className="p-3"><code className="text-sm">--continue-on-error</code></td>
                      <td className="p-3 text-sm text-muted-foreground">Continue execution on failures</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Enable <code className="text-xs bg-muted px-1 py-0.5 rounded">{"showMetrics: true"}</code> to collect timing data for performance analysis.
                    </p>
                  </div>
                </div>
              </div>
