        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              <code className="font-mono">curl-runner</code> provides CI-friendly exit codes that
              integrate seamlessly with popular CI/CD platforms. By default, the tool follows
              standard conventions where exit code 0 indicates success and exit code 1 indicates
              failure.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-lg border p-4">
                ...
                <p className="text-sm text-muted-foreground">Exit 1 if any validation fails</p>
              </div>
          ...
          <section>
            ...
            <div className="mt-6 rounded-lg border bg-blue-500/5 dark:bg-blue-500/10 border-blue-500/20 p-4">
              <p className="text-sm">
                ...
                together to run all tests before determining the final exit code. This ensures you
                get complete test results while still failing the pipeline when needed.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              All CI options can be configured via environment variables for easy integration with
              CI/CD platforms.
            </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Use <code>--continue-on-error</code> with <code>--strict-exit</code> to get
                      complete test results before failing.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      If the exit code is always 0 even with failures, check that you&apos;re using
                      CI options correctly:
                    </p>
              ...
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Common causes include network issues, missing environment variables, or timing
                      differences. Try increasing timeout and retry settings:
                    </p>
