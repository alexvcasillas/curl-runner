        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              ...
              subsequent requests. This is essential for building realistic API test workflows where
              requests depend on each other, such as authentication flows, CRUD operations, and data
              pipelines.
            </p>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              Use the <code className="text-sm bg-muted px-1 py-0.5 rounded">store</code> property
              in your request to extract and save response values. Reference stored values using the{' '}
            ...
            <div className="mt-6 rounded-lg border bg-muted/50 p-4">
              ...
              <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                ...
                <li>
                  Values are extracted based on the <code>store</code> configuration
                </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground mb-6">
              The store configuration uses dot-notation paths to extract values from different parts
              of the response.
            </p>
              ...
              <div className="rounded-lg border bg-card p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Only store values you'll actually use. This keeps your configuration clean and
                      makes it easier to understand the data flow.
                    </p>
                  </div>
                </div>
              </div>
