...
export const metadata: Metadata = {
	...
	openGraph: {
		...
		description: 'Learn curl-runner through comprehensive tutorials covering API testing, CI/CD integration, load testing, and advanced workflows.',
						...
						<div className="flex">
							...
							<div className="ml-3">
								...
								<div className="mt-2 text-sm text-muted-foreground">
									<p>
										Start with our{' '}
										<Link href="/docs/quick-start" className="font-medium text-blue-600 hover:underline">
											Quick Start Guide
										</Link>{' '}
					...
					<section>
						...
						<div className="grid gap-6 md:grid-cols-1 lg:grid-cols-2">
							{tutorials.map((tutorial) => {
								...
								return (
									<div key={tutorial.title} className="rounded-lg border bg-card p-6 hover:shadow-md transition-shadow">
						...
						<div className="rounded-lg border bg-card p-6">
							...
							<div className="flex gap-4">
								<Button asChild variant="outline">
									<Link href="https://github.com/alexvcasillas/curl-runner/discussions" target="_blank">
										GitHub Discussions
									</Link>
								</Button>
								<Button asChild variant="outline">
