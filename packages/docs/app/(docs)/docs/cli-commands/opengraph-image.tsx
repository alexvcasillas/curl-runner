...
export const alt = 'CLI Commands | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <span style={{ color: '#e2e8f0', fontSize: 18 }}>--verbose</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 20 }}>⚡</div>
              <span style={{ color: '#e2e8f0', fontSize: 18 }}>--parallel</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 20 }}>💾</div>
              <span style={{ color: '#e2e8f0', fontSize: 18 }}>--output</span>
            </div>
          </div>
        </div>
