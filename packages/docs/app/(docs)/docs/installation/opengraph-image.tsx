...
export const alt = 'Installation | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          Get curl-runner installed and running
        </p>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>npm</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>🚀</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>bun</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ fontSize: 20 }}>⚡</div>
            <span style={{ color: '#e2e8f0', fontSize: 18 }}>global</span>
          </div>
        </div>
      </div>
