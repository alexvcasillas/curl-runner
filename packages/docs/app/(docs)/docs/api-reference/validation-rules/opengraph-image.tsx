      ...
      >
        ...
        <div
          style={{
            ...
            height: '100%',
            opacity: 0.1,
            backgroundImage: 'radial-gradient(circle at 25% 25%, #ec4899 0%, transparent 50%), radial-gradient(circle at 75% 75%, #db2777 0%, transparent 50%)',
          }}
        />
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <span style={{ color: '#e2e8f0', fontSize: 18 }}>Assertions</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 20 }}>🔍</div>
              <span style={{ color: '#e2e8f0', fontSize: 18 }}>Patterns</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ fontSize: 20 }}>✨</div>
