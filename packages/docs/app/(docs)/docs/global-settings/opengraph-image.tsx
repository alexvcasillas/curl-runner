...
export const alt = 'Global Settings | curl-runner Documentation';
export const size = {
  width: 1200,
  height: 630,
};
    ...
    >
      ...
      <div
        style={{
          ...
          opacity: 0.1,
          backgroundImage:
            'radial-gradient(circle at 25% 25%, #6366f1 0%, transparent 50%), radial-gradient(circle at 75% 75%, #4f46e5 0%, transparent 50%)',
        }}
      />
      ...
      >
        ...
        >
          Configure behavior and shared settings
        </p>
